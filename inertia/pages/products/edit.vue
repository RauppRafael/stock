...
<template>
  ...
  <div class="p-4 sm:p-6 lg:p-8 max-w-3xl mx-auto">
    <PageHeader
      ...
      description="Add new attribute combinations to introduce more variants. Existing variants and stock are untouched."
    >
      <template #actions>
        <Link route="products.show" :params="{ id: product.id }" class="btn-ghost">Cancel</Link>
      </template>
    </PageHeader>
      ...
      <template v-if="category">
        ...
        <div>
          ...
          <p class="text-xs text-slate-500 mb-4">
            Selecting additional values creates new variant combinations. Removing a value here
            does <em>not</em> remove the variant — it stays so its history is preserved.
          </p>
